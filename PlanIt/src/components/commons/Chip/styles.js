...
export const ChipWrapper = styled.div`
    ...
    border: ${({ state }) => state === 'selected' ? '0.5px solid var(--color-border-brand-default)' : 'none'};
    background: ${({ state }) => state === 'selected' ? 'var(--color-background-default-default)': 'var(--color-background-default-secondary)'};
